...
#[derive(Clone)]
pub struct StrategyManagerPython {
...
#[async_trait]
impl EventEmitter<ExecutionCommand> for StrategyManagerPython {
...
#[async_trait]
impl EventSink<Kline> for StrategyManagerPython {
